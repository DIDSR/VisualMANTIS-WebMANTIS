...
UI.Input.prototype.setTitle = function ( value ) {
...
UI.TextArea.prototype.addValue = function ( value ) {

	this.dom.value = this.dom.value + value;
...
UI.Select.prototype.addOption = function(s)
{
	//var selected = this.dom.value;
...
UI.Slider = function( t )
{
	...
	{
		t.setValue('Photon History: '+this.value+' ');
...
UI.Slider.prototype.setRange = function ( min, max ) {
...
UI.Slider.prototype.setStep = function ( s ) {
...
UI.Slider.prototype.setValue = function ( v ) {
...
UI.Slider.prototype.getValue = function ( v ) 
{
	return parseInt( this.dom.value );
};
